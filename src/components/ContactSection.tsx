      ...
      <div className="section-container">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-surface-dark-foreground mb-4">
            Ready to Monetize Your Energy Assets?
          </h2>
          <p className="text-surface-dark-foreground/60 text-lg mb-10">
            Get a detailed revenue assessment for your battery storage, CHP, or hybrid asset in Baltic electricity markets.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a
              href="mailto:info@forwardit.lv?subject=Technical Walkthrough Request"
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-surface-dark-foreground/50 text-sm">
